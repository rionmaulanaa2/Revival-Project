...
class CustomBattleSettingWidget(object):
    ...
    def __init__(self, node, custom_battle_dict):
        ...
        for idx, offset in enumerate(self.offset_anchors):
            self.offset_anchors[idx] = offset - 48
    ...
    def init_widget(self):
        ...
        self.code_2_content_and_btn = {1: (
           ...
           29: (
              list_other_s.GetItem(1).bar_choose_1.btn_choose_1, list_other_s.GetItem(1).bar_content_1, list_other_s.GetItem(1).lab_title, list_other_s.GetItem(1).bar_content_1.lab_content_1)
           }
        self.double_groups = [
         (1, 2), (3, 4), (5, 6), (14, 15)]
