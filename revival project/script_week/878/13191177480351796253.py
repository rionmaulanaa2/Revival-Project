...
class RobotMechaMgr(FightNPCMgrBase):
    ...
    def on_hurt(self, robot_id, damage):
        ...
        if mecha:
            ...
            elif self._mecha_hp_lock:
                mecha_cur_hp = mecha.logic.ev_g_hp()
                mecha_max_hp = mecha.logic.ev_g_max_hp()
                if mecha_cur_hp > mecha_max_hp * 0.6 and damage < mecha_cur_hp:
    ...
    def set_mecha_hp_lock(self, flag):
        self._mecha_hp_lock = flag
