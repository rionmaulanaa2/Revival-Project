...
class PartPickableManager(ScenePart.ScenePart):
    ...
    def update_pickable(self):
        ...
        if not check_pos:
            ...
            pickable_set = {}
            changed = False
            if global_data.battle and global_data.battle.enable_faction_rescue():
                group_id = global_data.player.logic.ev_g_camp_id() if global_data.player and global_data.player.logic else None
            else:
 ...
 505      57  LOAD_FAST             4  'result'
          60  LOAD_CONST            3  ''
          63  BINARY_SUBSCR    
          64  POP_JUMP_IF_FALSE    83  'to 83'

 506      67  LOAD_FAST             4  'result'
          70  LOAD_CONST            4  1
          73  BINARY_SUBSCR    
          74  LOAD_ATTR             3  'y'
          77  STORE_FAST            5  'y'
 ...
 508      83  LOAD_CONST            5  400
          86  STORE_FAST            5  'y'
        89_0  COME_FROM                '80'

 509      89  LOAD_FAST             5  'y'
          92  RETURN_VALUE     
          -1  RETURN_LAST      
