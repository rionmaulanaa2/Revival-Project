...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityLoopCollectionCharge.py
from __future__ import absolute_import
from logic.comsys.activity.ActivityArtCollectionCharge import ActivityArtCollectionCharge
from common.cfg import confmgr
from logic.gutils import loop_lottery_utils, mall_utils

class ActivityLoopCollectionCharge(ActivityArtCollectionCharge):

    def init_parameters(self):
        super(ActivityLoopCollectionCharge, self).init_parameters()
