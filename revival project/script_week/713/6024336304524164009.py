...
Parse error at or near `CALL_FUNCTION_513' instruction at offset 21
 ...
 360      80  LOAD_CLOSURE          0  'yuanbao_real_price'
 ...
 370     101  LOAD_GLOBAL           7  'get_text_local_content'
         104  LOAD_CONST            3  12122
         107  CALL_FUNCTION_1       1 
         110  LOAD_ATTR             8  'format'
         113  LOAD_CONST            4  'img1'

 371     116  LOAD_CONST            5  '<color=0XFFFFFFFF><img ="gui/ui_res_2/icon/icon_exchange.png",scale=0.0></color>'
         119  LOAD_CONST            6  'img2'

 372     122  LOAD_CONST            7  '<color=0XFFFFFFFF><img ="gui/ui_res_2/icon/icon_crystal.png",scale=0.0></color>'
         125  LOAD_CONST            8  'num'

 373     128  LOAD_DEREF            0  'yuanbao_real_price'
         131  CALL_FUNCTION_768   768 
         134  STORE_FAST            1  'content_text'

 375     137  LOAD_CONST            9  ''
 ...
 376     153  LOAD_FAST             2  'SecondConfirmDlg2'
         156  CALL_FUNCTION_0       0 
         159  LOAD_ATTR            11  'confirm'
         162  LOAD_CONST           11  'content'

 377     165  LOAD_FAST             1  'content_text'
         168  LOAD_CONST           12  'confirm_callback'

 378     171  LOAD_CONST           13  'unique_key'

 379     174  LOAD_CONST           14  'use_yuanbao'
         177  CALL_FUNCTION_768   768 
         180  POP_TOP          

 382     181  LOAD_CONST            0  ''
         184  RETURN_END_IF    
       185_0  COME_FROM                '27'

 384     185  LOAD_GLOBAL           1  'mall_utils'
 ...
 385     209  LOAD_CONST            0  ''
         212  RETURN_END_IF    
       213_0  COME_FROM                '206'

 387     213  LOAD_DEREF            4  '_pay'
