...
class PartBattle(ScenePart.ScenePart):
    ...
    def __init__(self, scene, name):
        ...
        self._ccmini_faction_aoi_manager = None
    ...
    def on_load(self):
        ...
        self.create_ccmini_faction_aoi()
    ...
    def on_exit(self):
        ...
        self.destroy_ccmini_faction_aoi()
        self.clear_timer()
        self.clear_effect()
        if global_data.is_pc_mode:
    ...
    def create_ccmini_faction_aoi(self):
        player = global_data.player
        if not player:
            return
        if not (player.is_in_room() and player.is_custom_faction_room()):
            return
        from . import CCMiniFactionAoiManager
        self._ccmini_faction_aoi_manager = CCMiniFactionAoiManager.CCMiniFactionAoiManager()
    ...
    def destroy_ccmini_faction_aoi(self):
        if self._ccmini_faction_aoi_manager:
            self._ccmini_faction_aoi_manager.destroy()
        self._ccmini_faction_aoi_manager = None
        return
