...
class PartCtrl(ScenePart.ScenePart):
    ENTER_EVENT = {'scene_player_setted_event': 'on_player_setted',
       ...
       'override_sensitivity_event': 'override_sensitivity'
       }
    ...
    def __init__(self, scene, name):
        ...
        self._override_sensitivity = False
        return
    ...
    def override_sensitivity(self, value):
        self._override_sensitivity = value

    def is_override_sensitivity(self):
        return self._override_sensitivity
    ...
    def on_touch_rotate_camera(self, dx, dy, touches, touch_pos, adjust_sensitivity=True, need_check_speed=True):
        ...
        if adjust_sensitivity and not self._override_sensitivity:
            dx, dy = self.modify_rotate_dist_by_sensitivity(dx, dy, t_pos)
        ratio = 1.0
        if need_check_speed and self._enable_slide_helper and not self._override_sensitivity:
            ratio = self.modify_sense_by_dist(original_dx, original_dy, dx, dy, t_pos)
        if not self._override_sensitivity:
            win_h = global_data.ui_mgr.slide_screen_size.height
            win_w = global_data.ui_mgr.slide_screen_size.width
        else:
            win_h = global_data.ui_mgr.design_screen_size.height
            win_w = global_data.ui_mgr.design_screen_size.width
        dx *= ratio / win_w
        dy *= ratio / win_h
 ...
 749      24  LOAD_FAST             3  'game'
          27  LOAD_ATTR             2  'VK_SHIFT'
          30  BUILD_LIST_1          1 
          33  STORE_FAST            5  'state_keys'

 751      36  BUILD_MAP_4           4 

 752      39  LOAD_GLOBAL           3  'camera_const'
          42  LOAD_ATTR             4  'MOVE_DIR_0'
          45  LOAD_FAST             3  'game'
          48  LOAD_ATTR             5  'VK_W'
          51  STORE_MAP        

 753      52  LOAD_GLOBAL           3  'camera_const'
          55  LOAD_ATTR             6  'MOVE_DIR_180'
          58  LOAD_FAST             3  'game'
          61  LOAD_ATTR             7  'VK_S'
          64  STORE_MAP        

 754      65  LOAD_GLOBAL           3  'camera_const'
          68  LOAD_ATTR             8  'MOVE_DIR_270'
          71  LOAD_FAST             3  'game'
          74  LOAD_ATTR             9  'VK_A'
          77  STORE_MAP        

 755      78  LOAD_GLOBAL           3  'camera_const'
 ...
 774     282  LOAD_FAST             9  'can_run_debug_key_logic'
 ...
 775     301  LOAD_CONST            0  ''
         304  RETURN_END_IF    
       305_0  COME_FROM                '298'

 777     305  LOAD_FAST             8  'player'
         308  LOAD_CONST            0  ''
         311  COMPARE_OP            8  'is'
         314  POP_JUMP_IF_FALSE   321  'to 321'

 778     317  LOAD_CONST            0  ''
         320  RETURN_END_IF    
       321_0  COME_FROM                '314'

 779     321  LOAD_FAST             1  'msg'
         324  LOAD_FAST             3  'game'
         327  LOAD_ATTR            14  'MSG_KEY_DOWN'
         330  COMPARE_OP            2  '=='
         333  POP_JUMP_IF_FALSE   728  'to 728'

 780     336  LOAD_GLOBAL          16  'global_data'
 ...
 783     392  LOAD_GLOBAL          16  'global_data'
 ...
 788     494  LOAD_FAST            13  'com_camera'
 ...
 790     510  LOAD_FAST            13  'com_camera'
         513  LOAD_ATTR            34  'yaw'
         516  LOAD_FAST            12  'dx'
         519  CALL_FUNCTION_1       1 
         522  POP_TOP          

 791     523  LOAD_FAST             8  'player'
 ...
 794     572  LOAD_GLOBAL          16  'global_data'
 ...
 799     674  LOAD_FAST            13  'com_camera'
 ...
 801     690  LOAD_FAST            13  'com_camera'
         693  LOAD_ATTR            39  'pitch'
         696  LOAD_FAST            12  'dx'
         699  CALL_FUNCTION_1       1 
         702  POP_TOP          

 802     703  LOAD_FAST             8  'player'
 ...
 804     758  LOAD_GLOBAL          16  'global_data'
 ...
 805     779  LOAD_CONST            0  ''
         782  RETURN_END_IF    
       783_0  COME_FROM                '776'

 806     783  LOAD_CONST            1  ''
 ...
 807     799  LOAD_FAST            15  'scene_utils'
 ...
 810     842  LOAD_CONST            0  ''
         845  RETURN_END_IF    
       846_0  COME_FROM                '839'

 812     846  LOAD_FAST             2  'keycode'
 ...
 814     876  LOAD_CONST            0  ''
         879  RETURN_END_IF    
       880_0  COME_FROM                '873'

 816     880  LOAD_FAST             2  'keycode'
 ...
 856    1254  LOAD_GLOBAL          16  'global_data'
 ...
 857    1272  LOAD_DEREF            0  'a'
        1275  POP_JUMP_IF_TRUE   1282  'to 1282'

 858    1278  LOAD_CONST            0  ''
        1281  RETURN_END_IF    
      1282_0  COME_FROM                '1275'

 860    1282  LOAD_CONST           23  'TouchSimu'
 ...
 867    1332  LOAD_GLOBAL          16  'global_data'
 ...
 868    1350  LOAD_FAST            23  'control_target'
        1353  POP_JUMP_IF_FALSE  1378  'to 1378'

 869    1356  LOAD_FAST            23  'control_target'
 ...
 875    1424  LOAD_GLOBAL          16  'global_data'
 ...
 876    1442  LOAD_DEREF            0  'a'
        1445  POP_JUMP_IF_TRUE   1452  'to 1452'

 877    1448  LOAD_CONST            0  ''
        1451  RETURN_END_IF    
      1452_0  COME_FROM                '1445'

 879    1452  LOAD_CONST           23  'TouchSimu'
 ...
 889    1547  LOAD_FAST            23  'control_target'
 ...
 896    1621  LOAD_FAST            25  'cam_trk_component'
        1624  POP_JUMP_IF_FALSE  1658  'to 1658'

 897    1627  LOAD_GLOBAL          16  'global_data'
 ...
 905    1741  LOAD_GLOBAL          16  'global_data'
 ...
 907    1759  LOAD_CONST           23  'TouchSimu'
 ...
 921    1827  LOAD_GLOBAL          16  'global_data'
 ...
 922    1845  LOAD_FAST            23  'control_target'
        1848  POP_JUMP_IF_FALSE  1873  'to 1873'

 923    1851  LOAD_FAST            23  'control_target'
 ...
 929    1922  LOAD_GLOBAL          16  'global_data'
 ...
 931    1940  LOAD_CONST           23  'TouchSimu'
 ...
 959    2125  LOAD_FAST            23  'control_target'
 ...
 960    2141  LOAD_FAST            23  'control_target'
 ...
 961    2163  LOAD_FAST            23  'control_target'
 ...
 963    2185  LOAD_FAST            23  'control_target'
...
1005    2632  LOAD_FAST            23  'control_target'
