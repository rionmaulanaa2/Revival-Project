...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/component/client/ComSnowmanCollision.py
from __future__ import absolute_import
from .ComBuildingCollision import ComBuildingCollision
from logic.gcommon.common_const.collision_const import TERRAIN_MASK, GLASS_GROUP, GROUP_BREAK
from logic.gcommon.const import NEOX_UNIT_SCALE
import collision
import math3d

class ComSnowmanCollision(ComBuildingCollision):
    ...
    def _on_model_loaded(self, model):
        if not self.scene:
            ...
            self.col.mask = TERRAIN_MASK | GROUP_BREAK
