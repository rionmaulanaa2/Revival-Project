...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/mecha_ui/Mecha8024RushUI.py
...
class Mecha8024RushUI(BasePanel):
    ...
    def on_mecha_setted(self, mecha):
        ...
        if mecha:
            ...
            regist_func('E_SHOW_MECHA_LEFT_PROGRESS', self._show_dash_progress)
            regist_func('E_HIDE_MECHA_LEFT_PROGRESS', self._clsoe_dash_progress)
    ...
    def unbind_ui_event(self, target):
        ...
        if self.mecha and self.mecha.is_valid():
            ...
            unregist_func('E_SHOW_MECHA_LEFT_PROGRESS', self._show_dash_progress)
            unregist_func('E_HIDE_MECHA_LEFT_PROGRESS', self._clsoe_dash_progress)
    ...
    def _show_dash_progress(self, buff_id, data, left_time):
        if buff_id:
            ...
            self._max_buff_duration = conf.get('MaxDuration', 4.5)
        else:
