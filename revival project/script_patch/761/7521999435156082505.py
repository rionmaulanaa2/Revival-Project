...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/Death/DeathTopScoreUI.py
...
class DeathTopScoreUI(BasePanel):
    ...
    @execute_by_mode(False, (game_mode_const.GAME_MODE_HUNTING,))
