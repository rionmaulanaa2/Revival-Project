...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/rank/FashionRankWidget.py
...
class FashionRankWidget(BaseRankWidget):

    def __init__(self, parent_panel, nd, template_pos, rank_info):
        super(FashionRankWidget, self).__init__(rank_info)
        ...
        self.cur_rank_type = rank_const.RANK_TYPE_FASHION
