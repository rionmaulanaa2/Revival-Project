...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityGAGCTask.py
...
class ActivityGAGCTask(ActivityCollectNew):

    def __init__(self, dlg, activity_type):
        super(ActivityGAGCTask, self).__init__(dlg, activity_type)
        self.goods_id = '201800771'

    def on_init_panel(self):
        super(ActivityGAGCTask, self).on_init_panel()
    ...
    def set_show(self, show, is_init=False):
        super(ActivityGAGCTask, self).set_show(show, is_init)
        if show:
    ...
    def init_exchange_list_item(self):
        parent_task_id = confmgr.get('c_activity_config', activity_const.ACTIVITY_GUANGQI_ACTIVITY2, 'cTask', default='')
