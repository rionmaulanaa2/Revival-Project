...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/CandyHouseAdvanceUI.py
...
class CandyHouseAdvanceUI(SimpleAdvance):
    PANEL_CONFIG_NAME = 'activity/open_202003/open_candy_house'
    APPEAR_ANIM = 'appear'
    LASTING_TIME = 0.5
