...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/component/client/com_art_check/ComArtCheckMoveAppr.py
...
class ComArtCheckMoveAppr(UnitCom):
    ...
    def __init__(self):
        super(ComArtCheckMoveAppr, self).__init__()
