...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lottery/LotteryTurntableSecondComfirm.py
...
class LotteryTurntableSecondComfirm(BasePanel):
    ...
    def on_init_panel(self, text_id, first_click_callback, second_click_callback, *args, **kwargs):
        super(LotteryTurntableSecondComfirm, self).on_init_panel()
        self.panel.temp_second_confirm.lab_content.SetString(get_text_by_id(text_id))
