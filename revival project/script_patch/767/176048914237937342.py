...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lottery/LotterySSBanner.py
...
class LotterySSBanner(SimpleAdvance):
    PANEL_CONFIG_NAME = 'activity/lottery_ss_banner_5'
    APPEAR_ANIM = 'appear'
    LASTING_TIME = 0.5
    ...
    def on_init_panel(self, *args):
        self.ss_skin = 201800651
        self.s_skin = [201001641, 208106223, 201801041]
        super(LotterySSBanner, self).on_init_panel(*args)
    ...
    def on_click_btn(self, *args):
        jump_to_ui_utils.jump_to_lottery('34', self.ss_skin)