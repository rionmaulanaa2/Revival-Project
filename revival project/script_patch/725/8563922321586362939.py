...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/vscene/parts/gamemode/CRandomDeathMode.py
...
class CRandomDeathMode(object):
    ...
    def init_death_data_mgr(self):
        from logic.comsys.battle.RandomDeath.DeathBattleData import RandomDeathBattleData
        RandomDeathBattleData()
    ...
    def on_loading_end(self):
        ...
        bat and bat.client_loading_end()
