...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/lib/asyncore.py
import select
import socket
import sys
import time
...
_DISCONNECTED = frozenset((ECONNRESET, ENOTCONN, ESHUTDOWN, ECONNABORTED, EPIPE,
 EBADF, WSAECONNRESET, WSAECONNABORTED))
try:
    socket_map
except NameError:
    socket_map = {}
...
def poll2--- This code section failed: ---
 ...
 178       0  LOAD_FAST             1  'map'
           3  LOAD_CONST            0  ''
           6  COMPARE_OP            8  'is'
           9  POP_JUMP_IF_FALSE    21  'to 21'

 179      12  LOAD_GLOBAL           1  'socket_map'
          15  STORE_FAST            1  'map'
          18  JUMP_FORWARD          0  'to 21'
        21_0  COME_FROM                '18'

 180      21  LOAD_FAST             0  'timeout'
          24  LOAD_CONST            0  ''
          27  COMPARE_OP            9  'is-not'
          30  POP_JUMP_IF_FALSE    49  'to 49'

 182      33  LOAD_GLOBAL           2  'int'
 ...
 183      49  LOAD_GLOBAL           3  'select'
          52  LOAD_ATTR             4  'poll'
          55  CALL_FUNCTION_0       0 
          58  STORE_FAST            2  'pollster'

 184      61  LOAD_FAST             1  'map'
          64  POP_JUMP_IF_FALSE   374  'to 374'

 185      67  SETUP_LOOP          157  'to 227'
          70  LOAD_FAST             1  'map'
 ...
 192     171  LOAD_FAST             5  'flags'
         174  POP_JUMP_IF_FALSE    80  'to 80'

 195     177  LOAD_FAST             5  'flags'
 ...
 197     227  SETUP_EXCEPT         19  'to 249'

 198     230  LOAD_FAST             2  'pollster'
 ...
 201     286  RAISE_VARARGS_0       0 
         289  JUMP_FORWARD          0  'to 292'
       292_0  COME_FROM                '289'

 202     292  BUILD_LIST_0          0 
         295  STORE_FAST            6  'r'
...
class dispatcher():
    ...
    def connect(self, address):
        ...
        if err in (EINPROGRESS, EALREADY, EWOULDBLOCK, WSAEWOULDBLOCK, WSAEINPROGRESS, WSAEALREADY) or err == EINVAL and os.name in ('nt',
                                                                                                                                     'ce'):
            self.addr = address
            return
        if err in (0, EISCONN):
    ...
    def accept(self):
        try:
            ...
            if why.args[0] in (EWOULDBLOCK, ECONNABORTED, EAGAIN, WSAEWOULDBLOCK):
                return None
            raise
        else:
            return (
