...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivitySSAccumulateLottery.py
...
class ActivitySSAccumulateLottery(ActivityBase):

    def __init__(self, dlg, activity_type):
        super(ActivitySSAccumulateLottery, self).__init__(dlg, activity_type)
    ...
    def on_init_panel(self):
        ...
        if not global_data.player:
            return
        self.panel.temp_list.SetInitCount((len(self.prog_rewards) + 1) / 2)
    ...
    def _refresh_task_progress(self, is_init=False):
        ...
        self.panel.btn_get.SetEnable(is_receivable)
        self.panel.btn_get.img_light_btn and self.panel.btn_get.img_light_btn.setVisible(is_receivable)
    ...
    def update_receive_img(self, sub_item_widget, has_receive, is_receivable):
        img_node_path = 'gui/ui_res_2/charge/charge_bonus/img/img_progresspoint%d.png' % (1 if has_receive or is_receivable else 2)
