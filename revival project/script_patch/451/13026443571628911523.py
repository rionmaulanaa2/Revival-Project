...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityHalloweenMainUI.py
...
class ActivityHalloweenMainUI(ActivityMainUIBase):
    PANEL_CONFIG_NAME = 'activity/activity_202110/halloween/activity_main_halloween'
    ...
    def create_all_widget(self):
        ...
        from logic.gcommon.common_const.activity_const import WIDGET_HALLOWEEN
        self.activity_page_tab_widget = ActivityPreviewPageTabWidget(self, WIDGET_HALLOWEEN, select_cb=self._select_widget_cb, default_font_size=None)
        return
