...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/cdata/9005.py
from __future__ import absolute_import
_reload_all = True
version = '171803495'
from .mecha_status_config import *
cover = {'9005': {MC_JUMP_3: set([MC_JUMP_2, MC_JUMP_1, MC_BEAT_BACK, MC_TURN, MC_MOVE, MC_STAND, MC_RUN]),
            ...
            MC_BEAT_BACK: set([MC_JUMP_3, MC_JUMP_2, MC_JUMP_1, MC_FROZEN, MC_IMMOBILIZE, MC_TURN, MC_MOVE, MC_STAND, MC_RUN, MC_HIT]),
            MC_TURN: set([MC_STAND]),
            MC_MOVE: set([MC_TURN, MC_STAND, MC_RUN]),
...
forbid = {'9005': {MC_JUMP_3: set([MC_MECHA_BOARDING, MC_FROZEN, MC_IMMOBILIZE, MC_DEAD]),
            ...
            MC_SHOOT: set([MC_MECHA_BOARDING, MC_FROZEN, MC_IMMOBILIZE, MC_SHOOT, MC_DEAD, MC_BEAT_BACK]),
            ...
            MC_DEAD: set([]),
            MC_BEAT_BACK: set([MC_MECHA_BOARDING, MC_SHOOT, MC_DEAD]),
            MC_TURN: set([MC_JUMP_3, MC_JUMP_2, MC_JUMP_1, MC_MECHA_BOARDING, MC_FROZEN, MC_IMMOBILIZE, MC_DEAD, MC_BEAT_BACK, MC_MOVE, MC_RUN]),
            MC_MOVE: set([MC_JUMP_3, MC_JUMP_2, MC_JUMP_1, MC_MECHA_BOARDING, MC_FROZEN, MC_IMMOBILIZE, MC_DEAD, MC_BEAT_BACK, MC_MOVE]),
            MC_FROZEN: set([MC_MECHA_BOARDING, MC_DEAD]),
            MC_STAND: set([MC_JUMP_2, MC_JUMP_1, MC_FROZEN, MC_IMMOBILIZE, MC_DEAD, MC_BEAT_BACK]),
            MC_RUN: set([MC_JUMP_3, MC_JUMP_2, MC_JUMP_1, MC_MECHA_BOARDING, MC_FROZEN, MC_IMMOBILIZE, MC_SHOOT, MC_DEAD, MC_BEAT_BACK]),
