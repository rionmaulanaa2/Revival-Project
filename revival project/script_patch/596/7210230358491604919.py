...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/pve/PVEMainUIWidgetUI/PVEItemExchangeUI.py
from __future__ import absolute_import
from common.uisys.basepanel import BasePanel
from common.const.uiconst import DIALOG_LAYER_ZORDER
from logic.gcommon.const import SHOP_PAYMENT_YUANBAO, SHOP_PAYMENT_PVE_COIN
...
class PVEItemExchangeUI(BasePanel):
    ...
    def init_widget(self, consumed, diamond, pay_tip=True, cb=None):
        ...
        import math
        goods_id = mall_const.PVE_ITEM_DIAMOND_GIFT
        ...
        need_price_txt = '<color=0XFFFFFFFF><img ="%s",scale=0.0></color>%d' % (item_utils.get_money_icon(SHOP_PAYMENT_PVE_COIN), needed_diamond)
        real_price_txt = '<color=0XFFFFFFFF><img ="%s",scale=0.0></color>%d' % (item_utils.get_money_icon(SHOP_PAYMENT_YUANBAO), real_price)
        content = get_text_by_id(428, {'num1': need_price_txt,'num': real_price_txt})
