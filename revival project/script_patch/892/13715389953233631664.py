...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/BattleInfoConcert.py
...
class BattleInfoConcert(MechaDistortHelper, BattleInfoMessage):
    ...
    def on_init_panel(self, on_process_done=None):
        super(BattleInfoConcert, self).on_init_panel(on_process_done)
    ...
    def start_show(self):
        ...
        self.panel.stopActionByTag(1)
        self.panel.DelayCallWithTag(5, self.on_finish, 1)
