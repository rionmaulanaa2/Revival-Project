...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityAIConcert/ActivityAIConcertGo.py
...
ORIGIN_PRICE = 6
GAME_GOODS_ID = '693100002'
REMIND_DELTA_TIME = 1635522900

class ActivityAIConcertGo(ActivityBase):

    def __init__(self, dlg, activity_type):
        super(ActivityAIConcertGo, self).__init__(dlg, activity_type)
        self.init_parameters()
        self.init_ui_events()
        self.process_events(True)

    def set_show(self, show, is_init=False):
        super(ActivityAIConcertGo, self).set_show(show, is_init)
        if show:
    ...
    def init_parameters(self):
        ...
        self._jelly_goods_info = global_data.lobby_mall_data.get_activity_sale_info('AICONCERT_GO')
    ...
    def on_init_panel(self):
        super(ActivityAIConcertGo, self).on_init_panel()
        ...
        def OnClick(btn, touch):
            ...
            dlg.set_show_rule(609803, self._desc_text_id)
    ...
    def _refresh_left_time(self):
        ...
        self.panel.lab_time_01.SetString(day_txt)
    ...
    def on_finalize_panel(self):
        ...
        super(ActivityAIConcertGo, self).on_finalize_panel()