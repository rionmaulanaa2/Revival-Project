...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivitySummerLogin.py
...
class ActivitySummerLogin(ActivityCollect):

    def init_parameters(self):
        super(ActivitySummerLogin, self).init_parameters()
