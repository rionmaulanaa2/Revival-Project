...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/entities/HumanSurvivalBattle.py
...
class HumanSurvivalBattle(SurvivalBattle):
    ...
    def parachute_stage(self, stage_dict):
        ...
        is_outsider = global_data.player.logic.ev_g_is_outsider()
        exclude_list = [
