...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityKizunaaiHeadwearExchange.py
...
class ActivityKizunaaiHeadwearExchange(ActivityExchange):

    def __init__(self, dlg, activity_type):
        super(ActivityKizunaaiHeadwearExchange, self).__init__(dlg, activity_type)
    ...
    def on_finalize_panel(self):
        super(ActivityKizunaaiHeadwearExchange, self).on_finalize_panel()
        self.sub_widget = None
        return
    ...
    def init_parameters(self):
        super(ActivityKizunaaiHeadwearExchange, self).init_parameters()
    ...
    def get_task_list_template(self):
        return 'activity/activity_202103/kizunaai/i_task_exchange_headwear'
    ...
    def set_show(self, show, is_init=False):
        super(ActivityKizunaaiHeadwearExchange, self).set_show(show, is_init)
