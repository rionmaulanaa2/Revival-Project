...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lottery/LotteryBannerS5.py
...
class LotteryBannerS5(SimpleAdvance):
    ...
    def on_init_panel(self, *args):
        self.ss_skin = 201800151
        self.s_skin = [201001155, 201801343, 208103124, 208102323]
        super(LotteryBannerS5, self).on_init_panel(*args)
    ...
    def set_content(self):
        ...
        desc_text = 610141 if G_IS_NA_PROJECT else 81766
        self.panel.lab_des.SetString(desc_text)

    def on_click_btn(self, *args):
        jump_to_ui_utils.jump_to_lottery('31', self.ss_skin)