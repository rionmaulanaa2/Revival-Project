...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/rank/SeasonRankWidget.py
...
class SeasonRankWidget(BaseRankWidget):

    def __init__(self, parent_panel, nd, template_pos, rank_info):
        super(SeasonRankWidget, self).__init__(rank_info)
        ...
        self.cur_rank_type = rank_const.RANK_TYPE_BATTLEPASS
    ...
    def refresh_show_text(self):
        self._template_root.lab_score.setString(get_text_by_id(15049))
