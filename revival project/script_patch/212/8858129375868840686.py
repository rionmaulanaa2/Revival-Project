...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/Train/TrainEndUI.py
...
class TrainEndUI(DeathEndUI):
    ...
    def show_score(self, score_anim):
        super(TrainEndUI, self).show_score(score_anim)
