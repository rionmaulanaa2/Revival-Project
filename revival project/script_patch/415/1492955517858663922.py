...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/cdata/90108.py
_reload_all = True
version = '194199613'
from .pve_monster_status_config import *
cover = {'90108': {MC_JUMP_3: set([MC_JUMP_2, MC_JUMP_1, MC_BEAT_BACK, MC_TURN, MC_MOVE, MC_STAND, MC_RUN]),
             ...
             MC_MONSTER_AIMTURN: set([MC_JUMP_3, MC_MONSTER_MELEE, MC_TURN, MC_MOVE, MC_STAND, MC_RUN, MC_HIT]),
...
forbid = {'90108': {MC_JUMP_3: set([MC_MECHA_BOARDING, MC_MONSTER_MELEE, MC_FROZEN, MC_IMMOBILIZE, MC_DEAD, MC_MONSTER_AIMTURN]),
             MC_JUMP_2: set([MC_JUMP_3, MC_MECHA_BOARDING, MC_MONSTER_MELEE, MC_FROZEN, MC_IMMOBILIZE, MC_DEAD, MC_MONSTER_AIMTURN]),
             MC_JUMP_1: set([MC_JUMP_3, MC_JUMP_2, MC_MECHA_BOARDING, MC_MONSTER_MELEE, MC_FROZEN, MC_IMMOBILIZE, MC_DEAD, MC_BEAT_BACK, MC_MONSTER_AIMTURN]),
             ...
             MC_MOVE: set([MC_JUMP_2, MC_JUMP_1, MC_MECHA_BOARDING, MC_MONSTER_MELEE, MC_FROZEN, MC_IMMOBILIZE, MC_DEAD, MC_BEAT_BACK, MC_MONSTER_AIMTURN]),
             ...
             MC_RUN: set([MC_JUMP_2, MC_JUMP_1, MC_MECHA_BOARDING, MC_MONSTER_MELEE, MC_FROZEN, MC_IMMOBILIZE, MC_DEAD, MC_BEAT_BACK, MC_MONSTER_AIMTURN]),
