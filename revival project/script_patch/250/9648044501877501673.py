...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lobby/EntryWidget/LobbySummerActivityEntryWidget.py
...
class LobbySummerActivityEntryWidget(LobbyEntryWidgetBase):
    GLOBAL_EVENT = {}

    def on_init_widget(self):
        super(LobbySummerActivityEntryWidget, self).on_init_widget()
        ...
        def OnClick(*args):
            ...
            if not activity_list:
                ...
                return
            global_data.ui_mgr.show_ui('ActivitySummerMainUI', 'logic.comsys.activity.ActivitySummer')

    def on_finalize_widget(self):
        super(LobbySummerActivityEntryWidget, self).on_finalize_widget()
