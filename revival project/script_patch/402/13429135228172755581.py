...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityFairyland/ActivityFairylandSign.py
...
class ActivityFairylandSign(ActivityCollect):

    def init_parameters(self):
        super(ActivityFairylandSign, self).init_parameters()
