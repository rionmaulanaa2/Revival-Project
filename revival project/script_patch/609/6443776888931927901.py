...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/units/LSimplePortal.py
...
class LSimplePortal(Unit):

    def init_from_dict(self, bdict):
        super(LSimplePortal, self).init_from_dict(bdict)