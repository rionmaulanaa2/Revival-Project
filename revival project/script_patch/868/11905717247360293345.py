...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityKaixue/ActivityKaixueSign.py
...
class ActivityKaixueSign(ActivityCollect):

    def init_parameters(self):
        super(ActivityKaixueSign, self).init_parameters()
    ...
    def refresh_list(self):
        ...
        for i, task_id in enumerate(self._children_tasks):
            ...
            day_text_1 = '<fontname="gui/fonts/g93_en.otf"><size=34><color=0X2A4B73FF>{}</color></size></fontname>'.format(i + 1)
    ...
    def _init_get_all(self):
        ...
        if player.has_unreceived_task_reward(self._task_id):
            ...
            self.panel.btn_get.SetText(get_text_by_id(606011))
