...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lobby/InviteTeamConfirmUI.py
...
class InviteTeamConfirmUI(BasePanel):
    PANEL_CONFIG_NAME = 'lobby/team_appoint'
    ...
    def handle_slider(self):
        ...
        if percent >= 100.0:
            global_data.player.req_confirm(self.confirm_id, 3)
            self.close_invite()
            global_data.player.block_invite(self.uid)
        else:
    ...
    def set_invite_info(self, confirm_id, extra_info, confirm_type):
        ...
        self.uid = uid = extra_info.get('uid')
    ...
    def confirm(self, *args):
        global_data.player.req_confirm(self.confirm_id, 2)
        self.close()
