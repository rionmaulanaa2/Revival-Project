...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lottery/LotteryBannerS3.py
...
class LotteryBannerS3(SimpleAdvance):
    PANEL_CONFIG_NAME = 'activity/lottery_ss_banner_4'
    APPEAR_ANIM = 'appear'
    LASTING_TIME = 0.5
    ...
    def on_init_panel(self, *args):
        self.ss_skin = 201800551
        self.s_skin = [201800642, 201001548, 208200226, 208106224]
        super(LotteryBannerS3, self).on_init_panel(*args)
    ...
    def set_content(self):
        ...
        desc_text = 610324 if G_IS_NA_PROJECT else 610324
        self.panel.lab_des.SetString(desc_text)

    def on_click_btn(self, *args):
        jump_to_ui_utils.jump_to_lottery('40', self.ss_skin)