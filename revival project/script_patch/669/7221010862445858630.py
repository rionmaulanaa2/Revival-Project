...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityPay/ActivityPayMainUI.py
...
class ActivityPayMainUI(ActivityMainUIBase):
    ...
    def create_all_widget(self):
        ...
        from logic.gcommon.common_const.activity_const import WIDGET_PAY
        self.activity_page_tab_widget = ActivityPageTabWidget(self, WIDGET_PAY, select_cb=self._select_widget_cb)
