...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/MontageSDK/Backend/utils/Event.py
import sys
import weakref
import inspect
import collections
...
class Event(object):
    ...
    def _onFuncDie(self, wr):
        if wr in self.registerFuncs:
            self.registerFuncs.remove(wr)
