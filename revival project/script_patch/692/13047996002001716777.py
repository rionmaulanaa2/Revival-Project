...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/component/client/ComCrystalAppearance.py
...
class ComCrystalAppearance(ComBaseModelAppearance):
    ...
    def __init__(self):
        super(ComCrystalAppearance, self).__init__()
    ...
    def init_from_dict(self, unit_obj, bdict):
        super(ComCrystalAppearance, self).init_from_dict(unit_obj, bdict)
    ...
    def init_crystal_data(self):
        all_crystal = global_data.game_mode.get_cfg_data('crystal_data')
    ...
    def destroy(self):
        self.create_die_sfx()
        super(ComCrystalAppearance, self).destroy()
