...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/NewDeathMatchMapAdvanceUI.py
...
class NewDeathMatchMapAdvanceUI(SimpleAdvance):
    PANEL_CONFIG_NAME = 'activity/open_202201/open_powerplant'
    APPEAR_ANIM = 'appear'
    LASTING_TIME = 0.5
    NEED_GAUSSIAN_BLUR = False

    def on_init_panel(self, *args):
        super(NewDeathMatchMapAdvanceUI, self).on_init_panel()
