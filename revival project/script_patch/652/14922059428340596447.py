...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/Crown/CrownTopScoreUI.py
...
class CrownTopScoreUI(BasePanel):
    PANEL_CONFIG_NAME = 'battle_king/king_top_score'
    ...
    def update_group_score(self, data):
        ...
        for g_id in six.iterkeys(data):
            if g_id == self.group_id:
                blue_score = self.panel.lab_score_blue.getString()
                self.panel.lab_score_blue.SetString(str(data[g_id]))
                ...
                red_score = self.panel.lab_score_red.getString()
                self.panel.lab_score_red.SetString(str(data[g_id]))
