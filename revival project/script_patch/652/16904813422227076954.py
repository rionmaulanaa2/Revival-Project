...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityAutumnTrainTask.py
...
class ActivityAutumnTrainTask(ActivityCollect):

    def __init__(self, dlg, activity_type):
        super(ActivityAutumnTrainTask, self).__init__(dlg, activity_type)
    ...
    def on_finalize_panel(self):
        super(ActivityAutumnTrainTask, self).on_finalize_panel()
        self.sub_widget = None
        return
    ...
    def set_show(self, show, is_init=False):
        super(ActivityAutumnTrainTask, self).set_show(show, is_init)
    ...
    def show_list(self):
        ...
        random_children_tasks = player.get_random_children_tasks(random_refresh_type, self.random_task_id) or []
