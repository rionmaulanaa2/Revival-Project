...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/BattleInfoCircle.py
...
class BattleInfoCircle(MechaDistortHelper, BattleInfoMessage):
    PANEL_CONFIG_NAME = 'battle_tips/common_tips/fight_top_poison_tips'
    ...
    def on_init_panel(self, on_process_done=None):
        super(BattleInfoCircle, self).on_init_panel(on_process_done)
...
Parse error at or near `CALL_FUNCTION_2' instruction at offset 6
    ...
    def process_one_message(self, message, finish_cb):
        ...
        refresh_time, last_time, msg, reduce_type = message[0]
        self.cnt = 0
        ...
        addition_hide_time = refresh_time + last_time - cur_time
        ac_list = []
        if addition_hide_time > 0:
            ac_list.append(cc.DelayTime.create(addition_hide_time + 0.01))
        ac_list.extend([
