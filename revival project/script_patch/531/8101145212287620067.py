...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/NewDeathMatchMapUI.py
...
class NewDeathMatchMapUI(SimpleAdvance):
    PANEL_CONFIG_NAME = 'activity/new_mode_map/tdm_map_alpha'
    APPEAR_ANIM = 'appear'
    LASTING_TIME = 0.5
    NEED_GAUSSIAN_BLUR = False

    def on_init_panel(self, *args):
        super(NewDeathMatchMapUI, self).on_init_panel()
