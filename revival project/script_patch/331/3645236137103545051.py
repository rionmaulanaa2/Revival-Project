...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/message/FaceBookInviteList.py
...
from logic.comsys.message.FaceBookFriendList import FaceBookFriendList
...
class FaceBookInviteList(FaceBookFriendList):
    ...
    def on_touch_item(self, panel, uid):
        ...
        friend_utils.salog_friend_ui_oper(friend_utils.FRIEND_LOG_KEY_TEAM_INVITE_VIA_FACEBOOK)
        return
    ...
    def on_send_link(self):
        ...
        friend_utils.salog_friend_ui_oper(friend_utils.FRIEND_LOG_KEY_TEAM_SHARE_VIA_FACEBOOK)