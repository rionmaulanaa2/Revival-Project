...
MECHA_SETTING_LIST = {8004: [
   ...
   8014: [
        [
         [
          83483, 80594, 80595], {'key': uoc.SHOW_SLASH_TYPE_8014,'faq_text_id': 83491,'callback_func': global_data.emgr.dash_auto_defend_8019.emit}]],
   8018: [
        [
         [
   ...
   8020: [
        [
         [
          83130, 80594, 80595], {'key': uoc.ROCKER_CONTROL_CAMERA_8020,'faq_text_id': 83131,'callback_func': global_data.emgr.dash_auto_defend_8019.emit}]],
   8022: [
        [
         [
...
class MechaSettingWidget(SettingWidgetBase):
    ...
    def _refresh_panel(self, page):
        ...
        if not global_data.player:
            return
        self.key_2_callback_func.clear()
        self._setup_common_choose(page.nd_tab_mecha.choose_1, uoc.AIM_TRIGGER_PRESS_8007, 2285, flip=True)
        self._setup_common_choose(page.nd_tab_mecha.choose_2, uoc.BOOST_TRIGGER_PRESS_8010, 2290, flip=True)
        self._setup_common_choose(page.nd_tab_mecha.choose_3, uoc.JUMP_TRIGGER_PRESS_8004, 2291, callback_func=global_data.emgr.update_jump_trigger_press_8004.emit, flip=True)
        self._setup_common_choose(page.nd_tab_mecha.choose_4, uoc.JUMP_TRIGGER_PRESS_8008, 2291, callback_func=global_data.emgr.update_jump_trigger_press_8008.emit, flip=True)
        self._setup_common_choose(page.nd_tab_mecha.choose_5, uoc.CONTINUOUSLY_SHOOT_TRIGGER_PRESS_8012, 2301, flip=True)
        self._setup_common_choose(page.nd_tab_mecha.choose_6, uoc.BOOST_HIT_AUTO_TRIGGER_TRANSFORM_8012, 2333)
        self._setup_common_choose(page.nd_tab_mecha.choose_7, uoc.DASH_AUTO_DEFEND_8019, 609981, callback_func=global_data.emgr.dash_auto_defend_8019.emit)
        self._setup_common_choose(page.nd_tab_mecha.choose_8, uoc.ROCKER_CONTROL_CAMERA_8020, 83131, callback_func=global_data.emgr.enable_rocker_control_camera_8020.emit, btn_question=page.nd_tab_mecha.choose_8.lab_text.nd_auto_fit.btn_question)
        self._setup_common_choose(page.nd_tab_mecha.choose_9, uoc.MAIN_FIRE_ON_RELEASE_8022, 2291, callback_func=global_data.emgr.update_main_fire_on_release_8022.emit, flip=True)
        self._setup_common_choose(page.nd_tab_mecha.choose_10, uoc.JUMP_TRIGGER_PRESS_8022, 2291, callback_func=global_data.emgr.update_jump_trigger_press_8022.emit, flip=True)
        self._setup_common_choose(page.nd_tab_mecha.choose_11, uoc.FAST_AIM_FIRE_8023, 605023)
        self._setup_common_choose(page.nd_tab_mecha.choose_12, uoc.REOPEN_AIM_8023, 605027)
        self._setup_common_choose(page.nd_tab_mecha.choose_13, uoc.JUMP_TRIGGER_PRESS_8023, 2291, callback_func=global_data.emgr.update_jump_trigger_press_8023.emit, flip=True)
        self._setup_common_choose(page.nd_tab_mecha.choose_14, uoc.AUTO_INVISIBLE_8023, 605021)
        self._setup_common_choose(page.nd_tab_mecha.choose_15, uoc.AIM_RELOAD_WITHOUT_REOPEN_AIM_8023, 605029, btn_question=page.nd_tab_mecha.choose_15.lab_text.nd_auto_fit.btn_question)
        self._setup_common_choose(page.nd_tab_mecha.choose_16, uoc.SHIELD_TRIGGER_PRESS_8026, 2361, flip=True)
        self._setup_common_choose(page.nd_tab_mecha.choose_17, uoc.SUBWEAPON_FIRE_ON_AUTO_8027, 2378, callback_func=global_data.emgr.update_sub_fire_on_auto_8027.emit, flip=True)
        self._setup_combine_choose(page.nd_tab_mecha.choose_18, uoc.SHOTGUN_FIRE_ON_NOT_AUTO_8029, 2372, page.nd_tab_mecha.choose_19, uoc.SHOTGUN_FIRE_ON_RELEASE_8029, 2372, callback_func1=global_data.emgr.update_shotgun_fire_not_auto_8029.emit, callback_func2=global_data.emgr.update_shotgun_fire_on_release_8029.emit, flip=True)
        self._setup_common_choose(page.nd_tab_mecha.choose_20, uoc.TRANSLATION_USE_PHANTOM_FORWARD_8029, 2377, callback_func=global_data.emgr.update_translation_forward_8029.emit, flip=True)
        self._setup_common_choose(page.nd_tab_mecha.choose_21, uoc.ROCKER_JUMP_8030, 2382, callback_func=global_data.emgr.update_rocker_jump_8030.emit)
        self._setup_common_choose(page.nd_tab_mecha.choose_22, uoc.SHOW_SLASH_TYPE_8014, 83491, callback_func=global_data.emgr.update_show_slash_type_8014.emit)
        self._setup_common_choose(page.nd_tab_mecha.choose_23, uoc.DASH_TRIGGER_TYPE_8034, 2378, callback_func=global_data.emgr.update_dash_trigger_type_8034.emit)
