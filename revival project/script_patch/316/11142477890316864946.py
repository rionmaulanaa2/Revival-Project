...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/mode/BattleRoyaleKongdaoModeAdUI.py
...
class BattleRoyaleKongdaoModeAdUI(SimpleAdvance):
    PANEL_CONFIG_NAME = 'activity/open_202112/open_origo'
    APPEAR_ANIM = 'appear'
    LASTING_TIME = 0.5

    def on_init_panel(self, *args):
        super(BattleRoyaleKongdaoModeAdUI, self).on_init_panel()
