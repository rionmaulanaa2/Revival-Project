...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/entities/NewbieThirdLocalBattle.py
...
@Dynamic
class NewbieThirdLocalBattle(Battle):

    def __init__(self, entityid):
        super(NewbieThirdLocalBattle, self).__init__(entityid)
    ...
    def load_finish(self):
        ...
        global_data.sound_mgr.play_music('Custom3')
        self.create_barriers()
        super(NewbieThirdLocalBattle, self).load_finish()

    def destroy(self, clear_cache=True):
        self.remove_barriers()
        super(NewbieThirdLocalBattle, self).destroy()
