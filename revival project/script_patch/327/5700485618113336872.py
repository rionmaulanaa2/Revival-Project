...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/live/LiveFollowPageWidget.py
from __future__ import absolute_import
from logic.gcommon.common_utils.local_text import get_text_by_id
from logic.comsys.live.LivePageWidgetBase import LivePageWidgetBase

class LiveFollowPageWidget(LivePageWidgetBase):

    def __init__(self, parent_panel, list_type):
        super(LiveFollowPageWidget, self).__init__(parent_panel, list_type)
