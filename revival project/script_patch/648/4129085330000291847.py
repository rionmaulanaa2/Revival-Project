...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/entities/Field.py
from __future__ import absolute_import
from logic.entities.NPC import CacheableNPC
from mobile.common.EntityManager import Dynamic

@Dynamic
class Field(CacheableNPC):

    def __init__(self, entityid=None):
        super(Field, self).__init__(entityid)
    ...
    def init_from_dict(self, bdict):
        super(Field, self).init_from_dict(bdict)
