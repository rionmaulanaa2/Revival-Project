...
class LotteryCommonMutiTurntableWidget(LotteryBaseWidget):
    ...
    def init_parameters(self):
        ...
        self.table_id_dict = {NORMAL_TURNTABLE_WIDGET: get_goods_item_lottery_table_id(self.cur_single_goods_id_dict[NORMAL_TURNTABLE_WIDGET]),
           HIGH_TURNTABLE_WIDGET: get_goods_item_lottery_table_id(self.cur_single_goods_id_dict[HIGH_TURNTABLE_WIDGET])
           }
