...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/component/client/ComPVEBoxCollision.py
...
class ComPVEBoxCollision(UnitCom):
    BIND_EVENT = {'E_MODEL_LOADED': 'init_col',
       'E_ON_PVE_BOX_OPENED': 'on_opened'
       }

    def __init__(self, need_update=False):
        super(ComPVEBoxCollision, self).__init__(need_update)
        self.col = None
        return

    def init_from_dict(self, unit_obj, bdict):
        super(ComPVEBoxCollision, self).init_from_dict(unit_obj, bdict)
        self.col = None
        return
    ...
    def destroy(self):
        ...
        self.col = None
        super(ComPVEBoxCollision, self).destroy()
        return