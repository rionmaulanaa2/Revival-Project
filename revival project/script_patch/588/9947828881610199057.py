...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/mode/BattleRoyaleNightModeAdUI.py
...
class BattleRoyaleNightModeAdUI(SimpleAdvance):
    PANEL_CONFIG_NAME = 'activity/brv_night_open_ad'
    APPEAR_ANIM = 'appear'
    LASTING_TIME = 0.5

    def on_init_panel(self, *args):
        super(BattleRoyaleNightModeAdUI, self).on_init_panel()
