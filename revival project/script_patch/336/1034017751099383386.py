...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityChargeMainUI.py
...
class ActivityChargeMainUI(ActivityMainUIBase):
    DLG_ZORDER = NORMAL_LAYER_ZORDER_1

    def create_all_widget(self):
        from logic.comsys.activity.ActivityPageTabWidget import ActivityPageTabWidget
        from logic.gcommon.common_const.activity_const import WIDGET_CHARGE
        self.activity_page_tab_widget = ActivityPageTabWidget(self, WIDGET_CHARGE)
