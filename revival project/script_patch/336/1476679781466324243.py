...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/mecha_display/BlackFadeUI.py
...
class BlackFadeUI(BasePanel):
    PANEL_CONFIG_NAME = 'mech_display/black_fade'
