...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/component/client/ComFlag2BaseClient.py
...
class ComFlag2BaseClient(UnitCom):
    ...
    def __init__(self):
        super(ComFlag2BaseClient, self).__init__()
        self.faction_id = None
        self.sfx_id = None
        return

    def init_from_dict(self, unit_obj, bdict):
        super(ComFlag2BaseClient, self).init_from_dict(unit_obj, bdict)
    ...
    def destroy(self):
        ...
        super(ComFlag2BaseClient, self).destroy()
