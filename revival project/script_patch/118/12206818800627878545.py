...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/rank/DuelRankWidget.py
...
class DuelRankWidget(BaseRankWidget):

    def __init__(self, parent_panel, nd, template_pos, rank_info):
        super(DuelRankWidget, self).__init__(rank_info)
        ...
        self.cur_rank_type = rank_const.RANK_TYPE_DUEL
    ...
    def refresh_show_text(self):
        self._template_root.lab_score.setString(get_text_by_id(930014))
