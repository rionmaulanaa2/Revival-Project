...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/mecha_ui/Mecha8004DashUI.py
...
class Mecha8004DashUI(BasePanel):
    ...
    def on_mecha_setted(self, mecha):
        ...
        if mecha:
            ...
            regist_func('E_SHOW_DASH_LEFT_DURATION', self.show_dash_left_duration)
    ...
    def unbind_ui_event(self, target):
        ...
        if self.mecha and self.mecha.is_valid():
            ...
            unregist_func('E_SHOW_DASH_LEFT_DURATION', self.show_dash_left_duration)
        self.mecha = None
        return
    ...
    def show_dash_left_duration(self, left_duration):
        if left_duration > 0:
            self._show_dash_progress(left_duration)
        else:
            self._close_dash_progress()

    def _show_dash_progress(self, left_time):
