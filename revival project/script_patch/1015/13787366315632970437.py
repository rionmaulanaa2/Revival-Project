...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/common/live/blbl_live_agent.py
...
class BLBLLiveAgent(CCBasedLiveAgent):

    def __init__(self):
        super(BLBLLiveAgent, self).__init__()

    def init(self, live_data):
        super(BLBLLiveAgent, self).init(live_data)

    def destroy(self):
        super(BLBLLiveAgent, self).destroy()
