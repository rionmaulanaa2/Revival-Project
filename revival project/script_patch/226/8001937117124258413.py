...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/Granbelm/GranhackRuneListUI.py
...
class GranhackRuneListUI(BasePanel):
    PANEL_CONFIG_NAME = 'battle_hack/battle_talent_choose_main'
    ...
    def on_init_panel(self, *args, **kwargs):
        super(GranhackRuneListUI, self).on_init_panel()
        self.init_params()
    ...
    def init_list(self):
        ...
        for index, ui_item in enumerate(ui_list.GetAllItem()):
            conf = granhack_utils.get_rune_ability_display_dict(index)
            name = conf.get('name')
            path = conf.get('path')
            desc = conf.get('desc')
    ...
    def on_finalize_panel(self):
        ...
        super(GranhackRuneListUI, self).on_finalize_panel()