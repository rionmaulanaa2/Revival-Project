...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityDuanwuLogin.py
...
class ActivityDuanwuLogin(ActivityCollect):

    def init_parameters(self):
        super(ActivityDuanwuLogin, self).init_parameters()
