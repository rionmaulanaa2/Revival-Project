...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lobby/EntryWidget/LobbyALICEEntryWidget.py
...
class LobbyALICEEntryWidget(LobbyEntryWidgetBase):
    GLOBAL_EVENT = {}

    def on_init_widget(self):
        super(LobbyALICEEntryWidget, self).on_init_widget()
    ...
    def on_finalize_widget(self):
        super(LobbyALICEEntryWidget, self).on_finalize_widget()
