...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/Activity202202/ActivityBackToSchoolExchange.py
...
class ActivityBackToSchoolExchange(ActivityExchangeNew):

    def __init__(self, dlg, activity_type):
        super(ActivityBackToSchoolExchange, self).__init__(dlg, activity_type)

    def on_init_panel(self):
        super(ActivityBackToSchoolExchange, self).on_init_panel()
        self.init_describe()
