...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityChristmas/ActivityChristmasVeteranRecall.py
...
class ActivityChristmasVeteranRecall(ActivityBase):
    UZI_ID = 208101114
    UZI_ID_PIC = '/gui/ui_res_2/item/battle_item_skin/208101114.png'
    END_TIME = 1642021200

    def __init__(self, dlg, activity_type):
        super(ActivityChristmasVeteranRecall, self).__init__(dlg, activity_type)
    ...
    def on_init_panel(self):
        super(ActivityChristmasVeteranRecall, self).on_init_panel()
    ...
    def on_finalize_panel(self):
        ...
        super(ActivityChristmasVeteranRecall, self).on_finalize_panel()