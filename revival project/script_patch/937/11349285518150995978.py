...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/NewDeathMatchMapStadiumUI.py
...
class NewDeathMatchMapStadiumUI(SimpleAdvance):
    PANEL_CONFIG_NAME = 'activity/new_mode_map/new_map_extreme_stadium'
    APPEAR_ANIM = 'appear'
    LASTING_TIME = 0.5
    NEED_GAUSSIAN_BLUR = False

    def on_init_panel(self, *args):
        super(NewDeathMatchMapStadiumUI, self).on_init_panel()
