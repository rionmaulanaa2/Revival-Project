...
Parse error at or near `CALL_FUNCTION_2' instruction at offset 6
 ...
 161       0  LOAD_GLOBAL           0  'hasattr'
           3  LOAD_GLOBAL           1  'scene_debug_mark_list'
           6  CALL_FUNCTION_2       2 
           9  POP_JUMP_IF_FALSE    54  'to 54'

 162      12  SETUP_LOOP           27  'to 42'
          15  LOAD_FAST             0  'self'
...
Parse error at or near `CALL_FUNCTION_2' instruction at offset 6
    ...
    def test_model(self):
        ...
        model = world.model('model_new\\scene\\sky\\sun.gim', scn)
