...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ArtCollection/ActivityS3MainUI.py
...
class ActivityS3MainUI(ActivityMainUIBase):
    DLG_ZORDER = DIALOG_LAYER_ZORDER
    NEED_HIDE_MAIN_UI = False
    PANEL_CONFIG_NAME = 'mall/i_lottery_activity/s3/lottery_activity_main_s3'
    UI_ACTION_EVENT = {'btn_lose.OnClick': 'close'
       }
    activity_type = 'WIDGET_LOTTERY_S3'

    def init_parameters(self):
        super(ActivityS3MainUI, self).init_parameters()
