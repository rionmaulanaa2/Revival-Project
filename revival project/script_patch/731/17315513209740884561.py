...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lobby/EntryWidget/LobbyRedCliffEntryWidget.py
...
class LobbyRedCliffEntryWidget(LobbyEntryWidgetBase):
    ...
    def on_init_widget(self):
        super(LobbyRedCliffEntryWidget, self).on_init_widget()
    ...
    def on_click_btn(self, *args):
        ...
        if not activity_list:
            ...
            return
        global_data.ui_mgr.show_ui('ActivityRedCliffMainUI', 'logic.comsys.activity.ActivityRedCliff')
    ...
    def need_show_red_point(self):
        ...
        if not check_lobby_red_point():
            return False
        activity_list = activity_utils.get_ordered_activity_list(activity_const.WIDGET_RED_CLIFF)
