...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/sunshine/SunshineSDK/Plugin/RainbowPlugin/Platforms/NeoX/Asset/Renderers/MaterialThumbRenderer.py
import math3d
from neox import nxgui, world2
from .AssetThumbRenderer import AssetThumbRenderer

class MaterialThumbRenderer(AssetThumbRenderer):

    def __init__(self):
        super(MaterialThumbRenderer, self).__init__()
