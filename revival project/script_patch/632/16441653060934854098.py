...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityCommon/ActivityCommonSevenDayLoginGunTask.py
...
class ActivityCommonSevenDayLoginGunTask(ActivityBase):

    def __init__(self, dlg, activity_type):
        super(ActivityCommonSevenDayLoginGunTask, self).__init__(dlg, activity_type)
    ...
    def on_finalize_panel(self):
        ...
        super(ActivityCommonSevenDayLoginGunTask, self).on_finalize_panel()

    def on_init_panel(self):
        super(ActivityCommonSevenDayLoginGunTask, self).on_init_panel()
        self.process_event(True)
        self._init_gun_progress()
        self._refresh_gun_progress()

    def refresh_panel(self):
        super(ActivityCommonSevenDayLoginGunTask, self).refresh_panel()
        self._refresh_gun_progress()
