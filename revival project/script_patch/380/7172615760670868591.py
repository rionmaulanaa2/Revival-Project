...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/common_ui/WindowSmallBase.py
from __future__ import absolute_import
from common.uisys.basepanel import BasePanel
from common.const import uiconst

class WindowSmallBase(BasePanel):
    ...
    def on_init_panel(self, *args, **kwargs):
        ...
        if nd:
            ...
            if self.TITLE_TEXT_ID:
                nd.lab_title.SetString(self.TITLE_TEXT_ID)
        super(WindowSmallBase, self).on_init_panel(*args, **kwargs)
        return
