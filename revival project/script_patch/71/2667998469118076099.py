...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/cdata/90107.py
_reload_all = True
version = '196708105'
from .pve_monster_status_config import *
cover = {'90107': {MC_JUMP_3: set([MC_JUMP_2, MC_JUMP_1, MC_BEAT_BACK, MC_TURN, MC_MOVE, MC_STAND, MC_RUN]),
             ...
             MC_MONSTER_SUICIDE: set([MC_TURN, MC_MOVE, MC_STAND, MC_RUN, MC_HIT]),
...
forbid = {'90107': {MC_JUMP_3: set([MC_MECHA_BOARDING, MC_FROZEN, MC_IMMOBILIZE, MC_MONSTER_SUICIDE, MC_DEAD]),
             MC_JUMP_2: set([MC_JUMP_3, MC_MECHA_BOARDING, MC_FROZEN, MC_IMMOBILIZE, MC_MONSTER_SUICIDE, MC_DEAD]),
             MC_JUMP_1: set([MC_JUMP_3, MC_JUMP_2, MC_MECHA_BOARDING, MC_FROZEN, MC_IMMOBILIZE, MC_MONSTER_SUICIDE, MC_DEAD, MC_BEAT_BACK]),
             ...
             MC_MONSTER_SUICIDE: set([MC_JUMP_3, MC_JUMP_2, MC_JUMP_1, MC_MECHA_BOARDING, MC_FROZEN, MC_IMMOBILIZE, MC_DEAD, MC_BEAT_BACK]),
             ...
             MC_RUN: set([MC_JUMP_2, MC_JUMP_1, MC_MECHA_BOARDING, MC_FROZEN, MC_IMMOBILIZE, MC_MONSTER_SUICIDE, MC_DEAD, MC_BEAT_BACK]),
             MC_MOVE: set([MC_JUMP_2, MC_JUMP_1, MC_MECHA_BOARDING, MC_FROZEN, MC_IMMOBILIZE, MC_MONSTER_SUICIDE, MC_DEAD, MC_BEAT_BACK]),
