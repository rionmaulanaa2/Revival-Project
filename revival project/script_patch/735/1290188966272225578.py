...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityAIConcert/ActivityKizunaTrainTask.py
...
class ActivityKizunaTrainTask(ActivityCollect):

    def __init__(self, dlg, activity_type):
        super(ActivityKizunaTrainTask, self).__init__(dlg, activity_type)
    ...
    def on_finalize_panel(self):
        super(ActivityKizunaTrainTask, self).on_finalize_panel()
        self.sub_widget = None
        return
    ...
    def set_show(self, show, is_init=False):
        super(ActivityKizunaTrainTask, self).set_show(show, is_init)
