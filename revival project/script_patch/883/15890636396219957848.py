...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/BattleInfoParadropBall.py
...
class BattleInfoParadropBall(MechaDistortHelper, BattleInfoMessage):
    PANEL_CONFIG_NAME = 'battle_tips/common_tips/fight_top_s5_tips'
    ...
    def on_init_panel(self, on_process_done=None):
        super(BattleInfoParadropBall, self).on_init_panel(on_process_done)
