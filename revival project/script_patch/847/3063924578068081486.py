...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/ArmRace/ArmRaceStatisticsShareUI.py
...
class ArmRaceStatisticsShareUI(BasePanel):
    ...
    def on_init_panel(self, group_rank_data, my_uid, game_info=None, armrace_max_lv=None):
        ...
        self._armrace_max_lv = armrace_max_lv
    ...
    def on_finalize_panel(self):
        ...
        super(ArmRaceStatisticsShareUI, self).on_finalize_panel()
        return

    def _init_statistics_view(self):
        self.statistics_1v1_widget = global_data.uisystem.load_template_create('battle_arms_race/battle_score_detail', parent=self.panel.temp_ffa)
        data = self._group_rank_data
        nd_list = self.statistics_1v1_widget.list_score
        self.statistics_1v1_widget.btn_close.setVisible(False)
        ...
        for index, widget in enumerate(nd_list.GetAllItem()):
            ...
            for e_index, eid in enumerate(six_ex.keys(dict_data)):
                ...
                if armrace_lv > self._armrace_max_lv:
