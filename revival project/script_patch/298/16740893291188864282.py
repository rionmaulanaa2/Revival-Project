...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lobby/EntryWidget/Lobby520ActivityEntryWidget.py
...
class Lobby520ActivityEntryWidget(LobbyEntryWidgetBase):
    GLOBAL_EVENT = {}

    def on_init_widget(self):
        super(Lobby520ActivityEntryWidget, self).on_init_widget()
        ...
        def OnClick(*args):
            ...
            if not activity_list:
                ...
                return
            global_data.ui_mgr.show_ui('Activity520MainUI', 'logic.comsys.activity.Activity520')

    def on_finalize_widget(self):
        super(Lobby520ActivityEntryWidget, self).on_finalize_widget()
