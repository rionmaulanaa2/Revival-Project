...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/vscene/parts/gamemode/CMechaDeathMode.py
from __future__ import absolute_import
from logic.vscene.parts.gamemode.CDeathMode import CDeathMode
from mobile.common.EntityManager import EntityManager

class CMechaDeathMode(CDeathMode):

    def process_event(self, is_bind):
        super(CMechaDeathMode, self).process_event(is_bind)
    ...
    def on_target_revive(self):
        super(CMechaDeathMode, self).on_target_revive()
        global_data.ui_mgr.close_ui('MechaDeathPlayBackUI')
