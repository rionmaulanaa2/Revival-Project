...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityMidAutumn/ActivityMidAutumnExchange.py
...
class ActivityMidAutumnExchange(ActivityExchange):

    def __init__(self, dlg, activity_type):
        super(ActivityMidAutumnExchange, self).__init__(dlg, activity_type)
    ...
    def on_finalize_panel(self):
        super(ActivityMidAutumnExchange, self).on_finalize_panel()
        self.sub_widget = None
    ...
    def buy_good_success(self):
        super(ActivityMidAutumnExchange, self).buy_good_success()
        self.init_items()
    ...
    def init_parameters(self):
        super(ActivityMidAutumnExchange, self).init_parameters()
    ...
    def set_show(self, show, is_init=False):
        super(ActivityMidAutumnExchange, self).set_show(show, is_init)
