...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/items_book_ui/PetSkinGetUseBuyWidget.py
...
class PetSkinGetUseBuyWidget(object):
    ...
    def update_cancel_widget(self, can_cancel):
        self.cancel_btn and self.cancel_btn.setVisible(can_cancel)
    ...
    def refresh_widget(self):
        ...
        is_using = cur_pet_id == int(self.skin_no)
        self.update_cancel_widget(is_using)
        can_use = item_can_use and not is_using
    ...
    def on_click_use_btn(self, *args):
        if not self.skin_no:
            return
        global_data.player and global_data.player.set_choosen_pet(self.skin_no)
