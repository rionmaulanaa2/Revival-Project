...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/common/algorithm/euclid.py
...
class _EuclidMetaclass(type):
    ...
    def _create_setstate(cls, slots):
        ...
        def __setstate__(self, state):
            for name, value in six_ex.items(state):
...
class Vector2():
 ...
 200       0  LOAD_GLOBAL           0  'isinstance'
           3  LOAD_FAST             1  'other'
           6  LOAD_GLOBAL           1  'Vector2'
           9  CALL_FUNCTION_2       2 
          12  POP_JUMP_IF_FALSE    48  'to 48'

 201      15  LOAD_GLOBAL           1  'Vector2'
 ...
 205      48  LOAD_GLOBAL           1  'Vector2'
          51  LOAD_FAST             1  'other'
          54  LOAD_ATTR             2  'x'
          57  LOAD_ATTR             1  'Vector2'
          60  BINARY_SUBSCR    
          61  BINARY_SUBTRACT  

 206      62  LOAD_FAST             1  'other'
          65  LOAD_ATTR             3  'y'
          68  LOAD_ATTR             2  'x'
          71  BINARY_SUBSCR    
          72  BINARY_SUBTRACT  
...
Parse error at or near `BINARY_SUBTRACT' instruction at offset 61
    ...
    def angle_normalized(self, other):
    ...
    def signed_angle_normalized(self, other):
        theta = self.angle_normalized(other)
        xprod = Vector3(self.x, self.y, 0).cross(Vector3(other.x, other.y, 0))
        if xprod.z > 0:
            theta = -theta
        return theta
    ...
    def is_conversely(self, other):
        return (self + other).magnitude_squared() < self.magnitude_squared()
...
class Vector3():
 ...
 459       0  LOAD_GLOBAL           0  'isinstance'
           3  LOAD_FAST             1  'other'
           6  LOAD_GLOBAL           1  'Vector3'
           9  CALL_FUNCTION_2       2 
          12  POP_JUMP_IF_FALSE    61  'to 61'

 460      15  LOAD_GLOBAL           1  'Vector3'
          18  LOAD_FAST             1  'other'
          21  LOAD_ATTR             2  'x'
          24  LOAD_FAST             0  'self'
          27  LOAD_ATTR             2  'x'
 ...
 461      31  LOAD_FAST             1  'other'
          34  LOAD_ATTR             3  'y'
          37  LOAD_FAST             0  'self'
          40  LOAD_ATTR             3  'y'
          43  BINARY_SUBTRACT  

 462      44  LOAD_FAST             1  'other'
          47  LOAD_ATTR             4  'z'
          50  LOAD_FAST             0  'self'
          53  LOAD_ATTR             4  'z'
          56  BINARY_SUBTRACT  
 ...
 465      61  LOAD_GLOBAL           1  'Vector3'
          64  LOAD_FAST             1  'other'
          67  LOAD_ATTR             2  'x'
          70  LOAD_ATTR             1  'Vector3'
          73  BINARY_SUBSCR    
          74  BINARY_SUBTRACT  

 466      75  LOAD_FAST             1  'other'
          78  LOAD_ATTR             3  'y'
          81  LOAD_ATTR             2  'x'
          84  BINARY_SUBSCR    
          85  BINARY_SUBTRACT  

 467      86  LOAD_FAST             1  'other'
          89  LOAD_ATTR             4  'z'
          92  LOAD_ATTR             3  'y'
          95  BINARY_SUBSCR    
          96  BINARY_SUBTRACT  
