...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/items_book_ui/ProjectionKillListWidget.py
from __future__ import absolute_import
import six

class ProjectionKillListWidget(object):

    def __init__(self, parent, panel, on_create_item_callback, min_skin_count, on_select_equip_item=None, need_set_opacity_zero=False):
        self.parent = parent
        self.panel = panel
    ...
    def update_skin_data(self, skins_list, is_init=True, init_index=0):
    ...
    def init_select_item(self, index, off_set=None):
        ...
        select_widget and select_widget.bar.OnClick(True)
        return
    ...
    def init_list(self, is_init=True, select_idx=0):
        ...
        off_set_atfer = list_item.GetContentOffset()
        if is_init:
            off_set = off_set_atfer if 1 else off_set_before
