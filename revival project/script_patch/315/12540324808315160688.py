...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityAnnivMainUI.py
from __future__ import absolute_import
from common.uisys.basepanel import BasePanel
from common.const.uiconst import NORMAL_LAYER_ZORDER_1, UI_VKB_CLOSE
from logic.gutils import activity_utils
from logic.gcommon.common_const.activity_const import WIDGET_ANNIV

class ActivityAnnivMainUI(BasePanel):
    PANEL_CONFIG_NAME = 'activity/activity_202007/activity_princess_mila'
    ...
    def on_finalize_panel(self):
        ...
        if lobby_ui:
            lobby_ui.refresh_activity_entry_widget_redpoint()
        self.show_main_ui()
    ...
    def do_show_panel(self):
        super(ActivityAnnivMainUI, self).do_show_panel()
        self._show_times += 1
    ...
    def init_widget(self):
        ...
        ret_list = activity_utils.get_ordered_activity_list(WIDGET_ANNIV)
        if ret_list:
            tab_conf = ret_list[0]
    ...
    def create_all_widget(self):
        ...
        self.activity_page_tab_widget = ActivityPageTabWidget(self, WIDGET_ANNIV)
