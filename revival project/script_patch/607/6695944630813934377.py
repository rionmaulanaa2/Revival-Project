...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/common_ui/ScreenLockerUI.py
from __future__ import absolute_import
from common.uisys.basepanel import BasePanel
from common.const.uiconst import SCREEN_LOCKER_ZORDER, UI_TYPE_NO_RELEASE
from common.const import uiconst

class ScreenLockerUI(BasePanel):
