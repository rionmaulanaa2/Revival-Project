...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityPinganjing/ActivityPinganjingCalendar.py
from __future__ import absolute_import
from logic.comsys.activity.ActivityTemplate import ActivityTemplate
from .ActivityPinganjingCalendarMainUI import ActivityPinganjingCalendarMainUI

class ActivityPinganjingCalendar(ActivityTemplate):

    def on_init_panel(self):
        self.calendar_widget = ActivityPinganjingCalendarTabPage(self.panel)

    def on_finalize_panel(self):
        super(ActivityPinganjingCalendar, self).on_finalize_panel()
        self.calendar_widget.on_finalize_panel()


class ActivityPinganjingCalendarTabPage(ActivityPinganjingCalendarMainUI):
    ACTIVITY_ID = '21183'

    def __init__(self, panel):
        super(ActivityPinganjingCalendarTabPage, self).__init__(panel)
        self.process_event(True)
        self.refresh_share()

    def play_show_animation(self):
        super(ActivityPinganjingCalendarTabPage, self).play_show_animation()
    ...
    def init_panel(self):
        super(ActivityPinganjingCalendarTabPage, self).init_panel()
        ...
        def OnClick(btn, touch):
            ...
            if not getattr(self, '_share_content', None):
                from logic.comsys.share.PinganjingShareCreator import PinganjingShareCreator
                self._share_content = PinganjingShareCreator()
