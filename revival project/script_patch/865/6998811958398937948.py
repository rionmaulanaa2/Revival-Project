...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/common/live/kuaishou_live_agent.py
...
class KuaiShouLiveAgent(CCBasedLiveAgent):

    def __init__(self):
        super(KuaiShouLiveAgent, self).__init__()

    def init(self, live_data):
        super(KuaiShouLiveAgent, self).init(live_data)

    def destroy(self):
        super(KuaiShouLiveAgent, self).destroy()
