...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityGranbelmMainUI.py
...
class ActivityGranbelmMainUI(ActivityMainUIBase):
    PANEL_CONFIG_NAME = 'activity/activity_202004/activity_fullmoon_domestic'
    ...
    def create_all_widget(self):
        ...
        self.activity_page_tab_widget = ActivityPreviewPageTabWidget(self, WIDGET_GRANBELM)