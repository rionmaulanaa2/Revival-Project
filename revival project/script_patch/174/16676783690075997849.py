...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/ADCrystal/ADCrystalObserveEndUI.py
...
class ADCrystalObserveEndUI(DeathObserveEndUI):
    ...
    def show_score(self, score_anim):
        super(ADCrystalObserveEndUI, self).show_score(score_anim)
