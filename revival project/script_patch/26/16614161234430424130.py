...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/cdata/8501.py
from __future__ import absolute_import
_reload_all = True
from .mecha_status_config import *
cover = {'8501': {MC_DEAD: set([MC_TRANSFORM, MC_TURN, MC_USE_ITEM, MC_FROZEN, MC_STAND]),
            MC_TRANSFORM: set([MC_TURN, MC_USE_ITEM, MC_STAND, MC_DASH]),
            MC_TURN: set([]),
            MC_USE_ITEM: set([]),
            MC_FROZEN: set([MC_TRANSFORM, MC_TURN, MC_USE_ITEM, MC_STAND, MC_DASH]),
            MC_STAND: set([MC_TURN, MC_DASH]),
            MC_DASH: set([MC_STAND])
            },
   '8501_trans': {MC_JUMP_3: set([MC_JUMP_2, MC_JUMP_1, MC_BEAT_BACK, MC_TURN, MC_STAND, MC_RUN, MC_SUPER_JUMP, MC_MOVE, MC_HELP]),
                  ...
                  MC_MOVE: set([MC_JUMP_3, MC_TURN, MC_STAND, MC_RUN, MC_HELP]),
                  ...
                  MC_RUN: set([MC_TURN, MC_STAND, MC_MOVE, MC_HELP]),
...
forbid = {'8501': {MC_DEAD: set([]),
   ...
   '8501_trans': {MC_JUMP_3: set([MC_DEAD, MC_IMMOBILIZE, MC_FROZEN, MC_TRANSFORM]),
                  ...
                  MC_MOVE: set([MC_JUMP_2, MC_JUMP_1, MC_DEAD, MC_BEAT_BACK, MC_IMMOBILIZE, MC_FROZEN, MC_SUPER_JUMP]),
                  ...
                  MC_RUN: set([MC_JUMP_3, MC_JUMP_2, MC_JUMP_1, MC_SHOOT, MC_DEAD, MC_BEAT_BACK, MC_RELOAD, MC_IMMOBILIZE, MC_FROZEN, MC_SUPER_JUMP]),
