...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityFairyland/ActivityChineseValentineLogin.py
...
class ActivityChineseValentineLogin(ActivityCollect):

    def init_parameters(self):
        super(ActivityChineseValentineLogin, self).init_parameters()
