...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/component/client/ComMotorcyclePhysics.py
...
class ComMotorcyclePhysics(UnitCom):
    ...
    def __init__(self):
        super(ComMotorcyclePhysics, self).__init__(False)
        self.model_ref = None
        self.vehicle = None
        self.vtype = None
    ...
    def init_from_dict(self, unit_obj, bdict):
        super(ComMotorcyclePhysics, self).init_from_dict(unit_obj, bdict)
    ...
    def _accelerate(self):
        ...
        if self._can_accelerate:
            ...
            self.vehicle.engine_moi = self._get_phys_conf()['acc_engine_moi']
    ...
    def _get_vehicle_conf(self):
        ...
        self.vehicle_conf = confmgr.get('c_vehicle_res_config', str(self.sd.ref_mecha_id))
        return self.vehicle_conf
    ...
    def destroy(self):
        ...
        self.vehicle = None
        super(ComMotorcyclePhysics, self).destroy()
        return