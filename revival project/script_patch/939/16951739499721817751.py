...
class NewSeasonReward(BasePanel):
    PANEL_CONFIG_NAME = 'battle_pass/season_reward'
    ...
    def init_season_data(self):
        ...
        for i, item_no in enumerate(item_list):
            ...
            if nd_item:
                ...
                nd_item.bar_name.temp_level.bar_level.SetDisplayFrameByPath('', get_skin_rare_degree_icon(item_no))
    ...
    def init_stage_3(self):
        self.close()
        global_data.ui_mgr.show_ui('NewSeasonUI', 'logic.comsys.battle_pass')
