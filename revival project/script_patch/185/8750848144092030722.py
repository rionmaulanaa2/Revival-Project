...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivitySummer/ActivitySummerDiscount.py
...
class ActivitySummerDiscount(ActivityBase):

    def __init__(self, dlg, activity_type):
        super(ActivitySummerDiscount, self).__init__(dlg, activity_type)
    ...
    def init_anim(self):
        is_support_spine = global_data.feature_mgr.is_support_spine_3_8()
        self.panel.nd_content.character_red.red_img.setVisible(not is_support_spine)
        self.panel.treeleaf.setVisible(not is_support_spine)
    ...
    def on_click_btn_buy(self, *args):
        if mall_utils.item_has_owned_by_goods_id(self.goods_id):
    ...
    def on_click_anim(self, *args):
        spine_red = self.panel.nd_content.character_red.spine_red
        spine_red_shadow = self.panel.nd_content.character_red.spine_red_shadow
        spine_red.setAnimation(0, 'atk', False)
        spine_red.addAnimation(0, 'idle', True)
        spine_red_shadow.setAnimation(0, 'atk', False)
        spine_red_shadow.addAnimation(0, 'idle', True)
    ...
    def update_widget(self, *args):
        ...
        self.panel.nd_content.txt_discount.setVisible(not is_unlock)
        self.panel.nd_content.txt_rebate.setVisible(is_unlock)
        self.init_time_widget()
        self.init_btn_get()
        self.init_btn_vx()