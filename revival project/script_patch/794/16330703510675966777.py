...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ArtCollection/ActivityS4MainUI.py
...
class ActivityS4MainUI(ActivityMainUIBase):
    ...
    activity_type = 'WIDGET_LOTTERY_S4'

    def init_parameters(self):
        super(ActivityS4MainUI, self).init_parameters()
