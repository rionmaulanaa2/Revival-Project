...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/component/client/com_fire/ComFireBloodUI.py
...
class ComFireBloodUI(ComBloodUI):
    ...
    def __init__(self):
        super(ComFireBloodUI, self).__init__()
        self.force_hide = False
        self._target_bias = 0
        self._cur_bias = 0

    def init_from_dict(self, unit_obj, bdict):
        super(ComFireBloodUI, self).init_from_dict(unit_obj, bdict)
        self.init_ui_event()
    ...
    def _blood_bar_load_callback(self, model, *args):
        super(ComFireBloodUI, self)._blood_bar_load_callback(model, *args)

    def _get_socket(self):
        return ('empty', 90)

    def tick(self, dt):
        super(ComFireBloodUI, self).tick(dt)

    def tick_model_ui(self, model):
        super(ComFireBloodUI, self).tick_model_ui(model)
    ...
    def _on_hp_change(self, hp, mod):
        ...
        super(ComFireBloodUI, self)._on_hp_change(hp, mod)
        return

    def destroy(self):
        super(ComFireBloodUI, self).destroy()