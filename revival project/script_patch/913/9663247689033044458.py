...
class MainLoginUI(BasePanel):
 ...
 223      85  LOAD_GLOBAL           5  'global_data'
 ...
 224     115  LOAD_GLOBAL           5  'global_data'
         118  LOAD_ATTR             6  'channel'
         121  LOAD_ATTR             9  'logout'
         124  CALL_FUNCTION_0       0 
         127  POP_TOP          

 225     128  LOAD_CONST            0  ''
         131  RETURN_END_IF    
       132_0  COME_FROM                '112'

 227     132  LOAD_GLOBAL          10  'game3d'
