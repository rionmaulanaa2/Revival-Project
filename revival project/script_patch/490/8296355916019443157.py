...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/cdata/8503.py
from __future__ import absolute_import
_reload_all = True
from .mecha_status_config import *
cover = {'8503': {MC_DEAD: set([MC_TRANSFORM, MC_TURN, MC_USE_ITEM, MC_FROZEN, MC_STAND]),
   ...
   '8503_trans': {MC_JUMP_3: set([MC_JUMP_2, MC_JUMP_1, MC_BEAT_BACK, MC_TURN, MC_STAND, MC_RUN, MC_SUPER_JUMP, MC_MOVE, MC_HELP]),
...
forbid = {'8503': {MC_DEAD: set([]),
   ...
   '8503_trans': {MC_JUMP_3: set([MC_DEAD, MC_IMMOBILIZE, MC_FROZEN, MC_TRANSFORM]),
