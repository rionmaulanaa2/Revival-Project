...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/SSLevelSkinFullScreen.py
...
class SSLevelSkinFullScreen(SimpleAdvance):
    PANEL_CONFIG_NAME = 'activity/open_202008/open_kuma_tao_yugumo'
    SKIN_ID = 201800551
    APPEAR_ANIM = 'appear'
    LASTING_TIME = 0.5
    ...
    def set_content(self):
        ...
        is_en = get_cur_lang_name() == 'en'
        self.panel.nd_info_en.setVisible(is_en)
        self.panel.nd_info_ch.setVisible(not is_en)
