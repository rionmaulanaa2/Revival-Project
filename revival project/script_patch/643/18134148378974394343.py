...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityFairyland/ActivityFairylandExchange.py
...
from logic.gcommon.common_const.activity_const import ACTIVITY_FAIRYLAND_FOOD_EXCHANGE, ACTIVITY_FAIRYLAND_FOOD_DAILY_TASK
import cc
...
class ActivityFairylandExchange(ActivityExchange):

    def __init__(self, dlg, activity_type):
        super(ActivityFairylandExchange, self).__init__(dlg, activity_type)
        ...
        self.panel.pnl_icon.setVisible(True)
        return

    def on_finalize_panel(self):
        super(ActivityFairylandExchange, self).on_finalize_panel()
        self.sub_widget = None
        return
    ...
    def buy_good_success(self):
        super(ActivityFairylandExchange, self).buy_good_success()
        self.init_items()
    ...
    def init_parameters(self):
        super(ActivityFairylandExchange, self).init_parameters()
    ...
    def set_show(self, show, is_init=False):
        super(ActivityFairylandExchange, self).set_show(show, is_init)
    ...
    def refresh_item_num(self):
        ...
        self.panel.lab_have.SetString(get_text_by_id(907101).format(str(item_num)))
