...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/widget/AsyncAllReceiveTaskListWidget.py
...
class AsyncAllReceiveTaskListWidget(Widget):

    def __init__(self, panel, activity_type):
        super(AsyncAllReceiveTaskListWidget, self).__init__(panel, activity_type)
        self._timer = 0

    def on_init_panel(self):
        super(AsyncAllReceiveTaskListWidget, self).on_init_panel()
        ...
        self._collect_task = self._ui_data.get('change_task', '1410655')
    ...
    def on_finalize_panel(self):
        ...
        super(AsyncAllReceiveTaskListWidget, self).on_finalize_panel()

    def refresh_panel(self):
        super(AsyncAllReceiveTaskListWidget, self).refresh_panel()
            ...
            if task_num > 1:
                ...
                def OnClick(btn, touch):
                    ...
                    if self._collect_task:
                        global_data.player.receive_all_task_prog_reward(self._collect_task)
