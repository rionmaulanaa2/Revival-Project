...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/Duel/DuelJudgeResultUI.py
...
class DuelJudgeResultUI(BasePanel):
    ...
    def begin_result_show(self):
        ...
        self.bg_ui.hide_loading_percent()
