...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/Activity520/Activity520MarksmanTask.py
...
class Activity520MarksmanTask(ActivityCollect):

    def __init__(self, dlg, activity_type):
        super(Activity520MarksmanTask, self).__init__(dlg, activity_type)
        ...
        sub_act_list.SetTemplate('activity/activity_202105/520/i_task_common_marksman')
    ...
    def on_finalize_panel(self):
        super(Activity520MarksmanTask, self).on_finalize_panel()
        self.sub_widget = None
        return
    ...
    def init_parameters(self):
        super(Activity520MarksmanTask, self).init_parameters()
    ...
    def set_show(self, show, is_init=False):
        super(Activity520MarksmanTask, self).set_show(show, is_init)
