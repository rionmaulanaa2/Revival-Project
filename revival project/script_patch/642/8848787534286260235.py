...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/Crystal/CrystalBattleData.py
from __future__ import absolute_import
import six
from logic.comsys.battle.Death.DeathBattleData import DeathBattleData

class CrystalBattleData(DeathBattleData):

    def init_parameters(self):
        super(CrystalBattleData, self).init_parameters()
