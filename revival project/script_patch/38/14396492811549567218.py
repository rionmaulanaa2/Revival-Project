...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lobby/EntryWidget/Lobby2022SpringFestivalEntryWidget.py
...
class Lobby2022SpringFestivalEntryWidget(LobbyEntryWidgetBase):
    ...
    def on_init_widget(self):
        super(Lobby2022SpringFestivalEntryWidget, self).on_init_widget()
    ...
    def need_show_red_point(self):
        ...
        if not check_lobby_red_point():
            return False
        activity_list = activity_utils.get_ordered_activity_list(activity_const.WIDGET_SPRING_FESTIVAL)
