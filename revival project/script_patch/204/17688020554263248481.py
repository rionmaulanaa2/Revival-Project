...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/Death/RogueChooseBtnUI.py
...
class RogueChooseBtnUI(BasePanel):
    ENABLE_PIC = [
    ...
    def on_init_panel(self):
        ...
        if global_data.death_battle_data.check_pos_timer:
