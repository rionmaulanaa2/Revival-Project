...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityKizunaAILogin.py
...
class ActivityKizunaAILogin(ActivityCollect):

    def __init__(self, dlg, activity_type):
        super(ActivityKizunaAILogin, self).__init__(dlg, activity_type)
    ...
    def init_parameters(self):
        super(ActivityKizunaAILogin, self).init_parameters()
    ...
    def set_show(self, show, is_init=False):
        super(ActivityKizunaAILogin, self).set_show(show, is_init)
        self.show_animation()
