...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/Activity202201/ActivitySpringFestivalCharge.py
...
class ActivitySpringFestivalCharge(ActivityBase):

    def __init__(self, dlg, activity_type):
        super(ActivitySpringFestivalCharge, self).__init__(dlg, activity_type)
    ...
    def _refresh_charge_lab_rules(self, need_prog, reward_id):
        ...
        params = (need_prog * 10, get_lobby_item_name(item_no, need_part_name=False))
            ...
            for i, reward_info in enumerate(reward_list):
                ...
                if index == len(self.charge_prog_rewards) - 1:
                    ...
                    if is_init:
                        ...
                        nd_vx = global_data.ui_mgr.uis.load_template_create('mall/i_lottery_activity/spring/i_activity_spring_head', nd_parent, name='nd_head_vx')
