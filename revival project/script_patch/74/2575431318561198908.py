...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lobby/EntryWidget/GranbelmActivityEntryWidget.py
...
class GranbelmActivityEntryWidget(OldLobbyEntryWidgetBase):

    def __init__(self, parent_ui, panel):
        ui_config = {'entry_button_name': 'btn_activity',
           'ui_name': 'ActivityLotteryGranbelmMainUI',
        ...
        super(GranbelmActivityEntryWidget, self).__init__(parent_ui, panel, ui_config, event_conf)

    def destroy(self):
        super(GranbelmActivityEntryWidget, self).destroy()

    def get_activity_list(self):
        return activity_utils.get_ordered_activity_list(activity_const.WIDGET_LOTTERY_GRANBELM)