...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lobby/EntryWidget/SSActivityEntryWidget.py
...
class SSActivityEntryWidget(OldLobbyEntryWidgetBase):

    def __init__(self, parent_ui, panel):
        ui_config = {'entry_button_name': 'btn_activity',
           'ui_name': 'ActivitySSMainUI',
        ...
        super(SSActivityEntryWidget, self).__init__(parent_ui, panel, ui_config, event_conf)

    def destroy(self):
        super(SSActivityEntryWidget, self).destroy()
