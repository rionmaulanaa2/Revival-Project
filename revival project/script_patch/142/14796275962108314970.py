...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/skill/client/SkillDashHeat8037.py
from __future__ import absolute_import
from .SkillBase import SkillBase
from common.cfg import confmgr

class SkillDashHeat8037(SkillBase):

    def __init__(self, skill_id, unit_obj, data):
        super(SkillDashHeat8037, self).__init__(skill_id, unit_obj, data)
