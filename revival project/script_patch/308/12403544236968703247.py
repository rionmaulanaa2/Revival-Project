...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/component/client/ComCrystalCollision.py
...
class ComCrystalCollision(ComCommonShootCollision):
    ...
    def init_from_dict(self, unit_obj, bdict):
        super(ComCrystalCollision, self).init_from_dict(unit_obj, bdict)
