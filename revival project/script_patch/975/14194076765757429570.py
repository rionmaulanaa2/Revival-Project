...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/share/PinganjingShareCreator.py
from __future__ import absolute_import
from logic.comsys.share.ShareTemplateBase import ShareTemplateBase, async_disable_wrapper
from logic.comsys.activity.ActivityPinganjing.ActivityPinganjingCalendarMainUI import ActivityPinganjingCalendarMainUI

class PinganjingShareCreator(ShareTemplateBase):
    KIND = 'I_SHARE_SUMMER_CALENDAR_2022'

    def __init__(self):
        super(PinganjingShareCreator, self).__init__()

    @async_disable_wrapper
    def create(self, parent=None, init_cb=None, tmpl=None):
        super(PinganjingShareCreator, self).create(parent, tmpl)
        self._calendar_widget = ActivityPinganjingCalendarShare(self.panel)
    ...
    def destroy(self):
        ...
        super(PinganjingShareCreator, self).destroy()
        return


class ActivityPinganjingCalendarShare(ActivityPinganjingCalendarMainUI):
