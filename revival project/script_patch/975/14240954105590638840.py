...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityFairyland/ActivityFairylandGo.py
...
ORIGIN_PRICE = 6
GAME_GOODS_ID = '693100001'
REMIND_DELTA_TIME = 1630684740

class ActivityFairylandGo(ActivityBase):

    def __init__(self, dlg, activity_type):
        super(ActivityFairylandGo, self).__init__(dlg, activity_type)
        self.init_parameters()
        self.init_ui_events()
        self.process_events(True)

    def set_show(self, show, is_init=False):
        super(ActivityFairylandGo, self).set_show(show, is_init)
        if show:
    ...
    def init_parameters(self):
        ...
        self._jelly_goods_info = global_data.lobby_mall_data.get_fairyland_go_sale_info()
    ...
    def on_init_panel(self):
        super(ActivityFairylandGo, self).on_init_panel()
    ...
    def on_finalize_panel(self):
        ...
        super(ActivityFairylandGo, self).on_finalize_panel()