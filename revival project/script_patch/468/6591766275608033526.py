...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/lobby/EntryWidget/LobbyHalloweenActivityEntryWidget.py
...
class LobbyHalloweenActivityEntryWidget(LobbyEntryWidgetBase):
    ...
    def on_init_widget(self):
        super(LobbyHalloweenActivityEntryWidget, self).on_init_widget()
    ...
    def on_click_btn(self, *args):
        ...
        if not activity_list:
            ...
            return
        global_data.ui_mgr.show_ui('ActivityHalloweenMainUI', 'logic.comsys.activity')
    ...
    def need_show_red_point(self):
        ...
        if not check_lobby_red_point():
            return False
        activity_list = activity_utils.get_ordered_activity_list(activity_const.WIDGET_HALLOWEEN)
