...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/vscene/parts/gamemode/CGranbelmSurMode.py
...
class CGranbelmSurMode(CNormalBase):
    ...
    def init_mgr(self):
        super(CGranbelmSurMode, self).init_mgr()
    ...
    def create_gran_sur_ui(self):
        global_data.ui_mgr.show_ui('GranbelmRuneConfUI', 'logic.comsys.battle.Granbelm')

    def destroy_ui(self):
        close_ui_list = ('GranbelmConfUI', 'GranbelmListUI')
        for ui in close_ui_list:
            global_data.ui_mgr.close_ui(ui)

    def on_finalize(self):
        super(CGranbelmSurMode, self).on_finalize()
