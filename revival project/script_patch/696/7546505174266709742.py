...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/activity/ActivityAnniversaryBP.py
...
class ActivityAnniversaryBP(ActivityBase):

    def __init__(self, dlg, activity_type):
        super(ActivityAnniversaryBP, self).__init__(dlg, activity_type)
