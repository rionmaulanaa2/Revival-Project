...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/common_ui/WindowMediumBase.py
from __future__ import absolute_import
from common.uisys.basepanel import BasePanel
from common.const import uiconst

class WindowMediumBase(BasePanel):
    TEMPLATE_NODE_NAME = ''
    ...
    def on_init_panel(self, *args, **kwargs):
        ...
        super(WindowMediumBase, self).on_init_panel(*args, **kwargs)
        return
