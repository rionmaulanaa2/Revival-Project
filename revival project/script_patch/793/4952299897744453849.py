...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/pve/rank/PVERankMechaChooseWidget.py
...
class PVEMechaChooseWidget(object):
    ...
    def init_ui(self):
        ...
        def cmp_func(a, b):
            ...
            priority_a = bool(global_data.player.get_item_by_no(item_no_a))
            priority_b = bool(global_data.player.get_item_by_no(item_no_b))
    ...
    def process_events(self, is_bind):
        ...
        econf = {'on_pve_mecha_changed': self._update_pve_select_mecha,
           ...
           'on_pve_rank_model_load_complete': self._on_pve_main_model_load_complete
           }
    ...
    def _init_mecha_item(self, mecha_item, cur_index):
        ...
        has_mecha = bool(global_data.player and global_data.player.get_item_by_no(pve_mecha_id))
        ...
        if global_data.player and global_data.player.get_pve_selected_mecha_item_id() == pve_mecha_id:
    ...
    def _del_mecha_item_new(self, btn_mecha, mecha_id):
        pve_mecha_id = battle_id_to_mecha_lobby_id(mecha_id)
        if bool(global_data.player.get_item_by_no(pve_mecha_id)):
