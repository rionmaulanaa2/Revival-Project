...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/component/client/com_mecha_effect/ComMechaEffect8018.py
from __future__ import absolute_import
from .ComGenericMechaEffect import ComGenericMechaEffect
from common.utils import timer
RUSH_HIT_EFFECT_ID = '24'

class ComMechaEffect8018(ComGenericMechaEffect):
    BIND_EVENT = ComGenericMechaEffect.BIND_EVENT.copy()
    BIND_EVENT.update({'E_DO_OXRUSH_8018': '_on_rush',
       'E_CHRACTER_INITED': 'on_character_init',
       'E_SHOW_RUSH_HIT_SFX': 'on_show_rush_hit_sfx'
       })

    def init_from_dict(self, unit_obj, bdict):
        super(ComMechaEffect8018, self).init_from_dict(unit_obj, bdict)
    ...
    def destroy(self):
        ...
        super(ComMechaEffect8018, self).destroy()

    def on_model_loaded(self, model):
        super(ComMechaEffect8018, self).on_model_loaded(model)
    ...
    def on_show_rush_hit_sfx(self, pos, rot=None):
