...
class ComMechaStaticCollision(ComObjCollision):
    ...
    def _create_col_obj(self):
        if self.ev_g_death() or self.is_reycling:
            return
        else:
  ...
  89      12  LOAD_GLOBAL           1  'global_data'
  ...
  96     120  LOAD_GLOBAL          12  'MECHA_IDLE_BIPED_BONE_LOCAL_POS_Y'
 ...
 108     271  LOAD_DEREF            1  'model'
         274  LOAD_ATTR            26  'bounding_box'
         277  STORE_FAST            1  'box'

 109     280  LOAD_FAST             1  'box'
 ...
 110     305  LOAD_GLOBAL          28  'collision'
