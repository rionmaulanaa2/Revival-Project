...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/component/client/ComGoldeneggCollision.py
...
class ComGoldeneggCollision(ComCommonShootCollision):

    def __init__(self):
        super(ComGoldeneggCollision, self).__init__()
        self.timer_id = None
        return

    def init_from_dict(self, unit_obj, bdict):
        super(ComGoldeneggCollision, self).init_from_dict(unit_obj, bdict)
    ...
    def destroy(self):
        super(ComGoldeneggCollision, self).destroy()
