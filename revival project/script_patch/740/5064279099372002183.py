...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/gcommon/component/client/com_ai_ctrl/ComRemoteControl8003.py
...
class ComRemoteControl8003(UnitCom):
    ...
    def __init__(self):
        super(ComRemoteControl8003, self).__init__()

    def init_from_dict(self, unit_obj, bdict):
        super(ComRemoteControl8003, self).init_from_dict(unit_obj, bdict)

    def destroy(self):
        super(ComRemoteControl8003, self).destroy()
    ...
    def dash_start(self, dash_dir):
        ...
        global_data.game_mgr.delay_exec(0.1, lambda : self.send_event('E_MOVE_ROCK', math3d.vector(0, 0, 0), False))
