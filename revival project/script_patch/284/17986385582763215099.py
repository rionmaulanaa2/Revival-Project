...
# Embedded file name: /Users/netease/Documents/work/battlegrounds/gameplay/releases/rel_current/tools/patch/temp/script/logic/comsys/battle/BattleInfoArmRaceUzi.py
...
class BattleInfoArmRaceUzi(MechaDistortHelper, BattleInfoMessage):
    PANEL_CONFIG_NAME = 'battle_tips/arms_race_tips/i_arms_race_uzi_tips'
    DLG_ZORDER = BATTLE_MESSAGE_ZORDER
    UI_TYPE = UI_TYPE_MESSAGE
    PC_ROOT_NODE_POS_X = 201

    def on_init_panel(self, on_process_done=None):
        super(BattleInfoArmRaceUzi, self).on_init_panel(on_process_done)
...
Parse error at or near `CALL_FUNCTION_2' instruction at offset 6
    ...
    def process_one_message(self, message, finish_cb):
        ...
        first_point_num = message[0]
        self.panel.lab_num.SetString(str(first_point_num))
        self.cnt = 0
